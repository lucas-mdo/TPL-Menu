...
String subMenu1Items[] = {"0V", "10V", "20V", "30V", "40V", "50V"};
...
void subMenu1Draw() {
  ...
  lcd.clear();
  lcd.setCursor(1, 0);
  lcd.print(subMenu1Items[subMenu1Page]);
  lcd.setCursor(1, 1);
  lcd.print(subMenu1Items[subMenu1Page + 1]);
  if (subMenu1Page == 0) {
    lcd.setCursor(15, 1);
    lcd.write(byte(2));
  ...
  while (activeButton == 0) {
    ...
    switch (button) {
      ...
      case 2:
        button = 0;
        if (subMenu1Page == 0) {
          subMenu1cursorPosition = subMenu1cursorPosition - 1;
          subMenu1cursorPosition = constrain(subMenu1cursorPosition, 0, ((sizeof(subMenu1Items) / sizeof(String)) - 1));
        }
        if (subMenu1Page % 2 == 0 and subMenu1cursorPosition % 2 == 0) {
          subMenu1Page = subMenu1Page - 1;
          subMenu1Page = constrain(subMenu1Page, 0, maxSubMenu1Pages);
        }
